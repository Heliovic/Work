...
// COE_SAFE_FUNCTION:Disable accessing TypedArray subclass fields via offset
// Xposed modifies the size of TypedArray objects
...
// COE_SAFE_FUNCTION:Don't sharpen quickened method calls

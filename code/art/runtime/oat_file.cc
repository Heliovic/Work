...
__attribute__((weak))
bool OatFile::OatMethod::CheckExtendedVmapTable(const uint8_t* curr_vmap_table ATTRIBUTE_UNUSED) const {
  return false;
}

__attribute__((weak))
bool OatFile::OatMethod::DescribeVRegAtDexPc(std::ostream& os ATTRIBUTE_UNUSED,
                                             const DexFile::CodeItem* code_item ATTRIBUTE_UNUSED,
                                             size_t reg ATTRIBUTE_UNUSED,
                                             VRegKind kind ATTRIBUTE_UNUSED,
                                             size_t native_pc_offset ATTRIBUTE_UNUSED,
                                             InstructionSet isa ATTRIBUTE_UNUSED) const {
  return false;
}

__attribute__((weak))
void OatFile::OatMethod::DescribeVRegAtDexPc(std::ostream& os ATTRIBUTE_UNUSED,
                                             const DexFile::CodeItem* code_item ATTRIBUTE_UNUSED,
                                             const uint8_t* raw_vmap_sets ATTRIBUTE_UNUSED,
                                             size_t reg ATTRIBUTE_UNUSED,
                                             VRegKind kind ATTRIBUTE_UNUSED,
                                             size_t native_pc_offset ATTRIBUTE_UNUSED,
                                             InstructionSet isa ATTRIBUTE_UNUSED) const {
...
__attribute__((weak))
bool OatFile::OatMethod::DumpExtendedGcMapAtNativePcOffset(std::ostream& os ATTRIBUTE_UNUSED,
                                                           const DexFile::CodeItem* code_item ATTRIBUTE_UNUSED,
                                                           size_t native_pc_offset ATTRIBUTE_UNUSED,
                                                           InstructionSet isa ATTRIBUTE_UNUSED) const {
  return false;
...
__attribute__((weak))
bool OatFile::OatMethod::DumpExtendedVRegsAtDexPc(std::ostream& os ATTRIBUTE_UNUSED,
                                                  verifier::MethodVerifier* verifier ATTRIBUTE_UNUSED,
                                                  const DexFile::CodeItem* code_item ATTRIBUTE_UNUSED,
...
__attribute__((weak))
bool OatFile::OatMethod::DumpExtendedVmapTable() const {
  return false;
}
#endif

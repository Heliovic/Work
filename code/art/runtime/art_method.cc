...
// COE_SAFE_FUNCTION:Invocation handler for hooked methods
#ifdef __COE_SAFE_FUNCTION__
...
// COE_SAFE_FUNCTION:Introduce dummy method access flags
...
// COE_SAFE_FUNCTION:Add a method to place the hook for a method
#ifdef __COE_SAFE_FUNCTION__

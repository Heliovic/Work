...
__attribute__((weak))
MTKRuntime* GenMTKRuntime() {
  return nullptr;
}

__attribute__((weak))
void MTK_RuntimeStart1(jit::JitOptions* jit_options, Runtime* runtime) {
  UNUSED(jit_options);
  UNUSED(runtime);
}

__attribute__((weak))
void MTK_DidForkFromZygote(jit::JitOptions* jit_options, Runtime* runtime) {
  UNUSED(jit_options);
  UNUSED(runtime);
}

__attribute__((weak))
void MTK_CreateJit(jit::JitInstrumentationCache* instrumentation_cache) {
  UNUSED(instrumentation_cache);
}
#endif

#ifdef MTK_ART_PROFILER
__attribute__((weak))
void Runtime::StartPerfProf() {
}

__attribute__((weak))
void Runtime::StopPerfProf() {
}

__attribute__((weak))
void* Runtime::GetPerfProf() {
  return nullptr;
}
#endif

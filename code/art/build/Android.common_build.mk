...
ifeq ($(strip $(COE_SAFE_FUNCTION)), true)
  $(warning "cooee:    art define __COE_SAFE_FUNCTION__")
  art_cflags += -D__COE_SAFE_FUNCTION__
endif
...
ifeq ($(MTK_ART_OPT_ENABLE),true)
  ...
  ifeq ($(MTK_ART_COMPILER_BACKEND),quick)
    MTK_CFLAGS += -DMTK_ART_COMPILER_BACKEND=0
  else ifeq ($(MTK_ART_COMPILER_BACKEND),optimizing)
    MTK_CFLAGS += -DMTK_ART_COMPILER_BACKEND=1
  endif
endif
...
ifeq ($(MTK_SUSPEND_ALL_ACTIVE_THREADS_BEFORE_EXIT_ENABLE),true)
  MTK_CFLAGS += -DMTK_SUSPEND_ALL_ACTIVE_THREADS_BEFORE_EXIT
endif

#
#MTK dex2oat gmo whitelist
#
MTK_ART_GMO_DEX2OAT_WHITELIST := true
ifeq (yes,$(strip $(MTK_GMO_ROM_OPTIMIZE)))
  ifeq ($(MTK_ART_GMO_DEX2OAT_WHITELIST),true)
    MTK_CFLAGS += -DMTK_ART_GMO_DEX2OAT_WHITELIST
  endif
endif

...
void HI846_Sensor_update_wb_gain(kal_uint32 r_gain, kal_uint32 g_gain,kal_uint32 b_gain)
{
  kal_int16 temp;
    ...
    HI846_OTP_write_cmos_sensor(0x0508, g_gain >> 8); //gr_gain
    HI846_OTP_write_cmos_sensor(0x0509, g_gain & 0xFF); //gr_gain
    HI846_OTP_write_cmos_sensor(0x050a, g_gain >> 8); //gb_gain
    HI846_OTP_write_cmos_sensor(0x050b, g_gain & 0xFF); //gb_gain

    HI846_OTP_write_cmos_sensor(0x050c, r_gain >> 8); //r_gain
    HI846_OTP_write_cmos_sensor(0x050d, r_gain & 0xFF); //r_gain
    HI846_OTP_write_cmos_sensor(0x050e, b_gain >> 8); //b_gain
    HI846_OTP_write_cmos_sensor(0x050f, b_gain & 0xFF); //b_gain

  temp = read_cmos_sensor(0x0a05) | 0x08;
   pr_debug("%s, = 0x%x\n", __func__,temp);
    HI846_OTP_write_cmos_sensor(0x6000, temp); //Digital Gain enable
...
/*
#ifdef Hi846_I2C_BURST
static struct Hynix_Sensor_reg hi846_init_setting[] = 
{ 
...
LOG_INF("Enter init\n");
 ...
 write_cmos_sensor(0x2000, 0x000A); 
...
write_cmos_sensor(0x095A, 0x0180); 
